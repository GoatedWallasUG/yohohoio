(function(sttc) {
    ...
    }, da = ca(this), ea = typeof Symbol === "function" && typeof Symbol("x") === "symbol", u = {}, fa = {}, v = function(a, b, c) {
        if (!c || a != null) {
            c = fa[b];
            if (c == null)
                return a[b];
    ...
    var na = ja
      ...
      , qa = ea && typeof v(Object, "assign") == "function" ? v(Object, "assign") : function(a, b) {
        if (a == null)
    ...
    w("Map", function(a) {
        if (function() {
            if (!a || typeof a != "function" || !v(a.prototype, "entries") || typeof Object.seal != "function")
                return !1;
            try {
                var h = Object.seal({
                    x: 4
...
*/
    ...
    ;var $a = typeof u.Symbol === "function" && typeof (0,
    u.Symbol)() === "symbol";
    function ab(a, b, c) {
        return typeof u.Symbol === "function" && typeof (0,
        u.Symbol)() === "symbol" ? (c === void 0 ? 0 : c) && u.Symbol.for && a ? u.Symbol.for(a) : a != null ? (0,
        u.Symbol)(a) : (0,
        u.Symbol)() : b
    }
    ...
    }, jb = Object.defineProperties, F = $a ? bb : "eb", kb, lb = [];
    G(lb, 7);
    kb = Object.freeze(lb);
    function mb(a, b) {
        $a || F in a || jb(a, ib);
    ...
    function vb(a) {
        var b = wb;
        if (!a)
            throw Error((typeof b === "function" ? b() : b) || String(a));
    }
    function xb(a) {
        a.Ib = !0;
        return a
    ...
    function Mb(a, b) {
        ...
        if (b <= 2097151)
            ...
            pb() ? c = "" + (BigInt(b) << BigInt(32) | BigInt(a)) : (c = (a >>> 24 | b << 8) & 16777215,
            b = b >> 16 & 65535,
    ...
    function Ob() {
        var a = I
          , b = J;
        b & 2147483648 ? pb() ? a = "" + (BigInt(b | 0) << BigInt(32) | BigInt(a >>> 0)) : (b = y(Lb(a, b)),
        a = b.next().value,
        b = b.next().value,
        a = "-" + Mb(a, b)) : a = Mb(a, b);
        return a
    ...
    function lc(a) {
        ...
        if (a.length < 16)
            ...
            e += 6)
                ...
                J *= 1E6,
                I = I * 1E6 + d,
                I >= 4294967296 && (J += v(Math, "trunc").call(Math, I / 4294967296),
                J >>>= 0,
                I >>>= 0);
            b && (b = y(Lb(I, J)),
            a = b.next().value,
    ...
    ;function sc(a, b, c, d) {
        ...
        if (!(b & 1)) {
            var l = g && a[g - 1];
            l != null && typeof l === "object" && l.constructor === Object ? (g--,
            h = g) : l = void 0;
            if (m && !(b & 128) && !e) {
                k = !0;
                var p;
        ...
        if (l)
            for (var z in l)
                Object.prototype.hasOwnProperty.call(l, z) && (a = l[z],
                a != null && (a = c(a, d)) != null && (g = +z,
                e = void 0,
                m && !v(Number, "isNaN").call(Number, g) && (e = g + n) < h ? f[e] = a : (g = void 0,
                ((g = b) != null ? g : b = {})[z] = a)));
        b && (k ? f.push(b) : f[h] = b);
        return f
    }
    ...
    ;function xc(a, b) {
        ...
        if (Array.isArray(a)) {
            var c = a[F] | 0;
            a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = yc(a, c, !1, b && !(c & 16)) : (mb(a, 34),
            c & 4 && Object.freeze(a)));
            return a
        }
        if (a != null && a[hb] === qb)
            return b = a.i,
            c = b[F] | 0,
            H(a, c) ? a : zc(a, b, c) ? Ac(a, b) : yc(b, c)
    }
    function Ac(a, b, c) {
    ...
    function Bc(a) {
        var b = a.i
          , c = b[F] | 0;
        return H(a, c) ? zc(a, b, c) ? Ac(a, b, !0) : new a.constructor(yc(b, c, !1)) : a
    }
    function Cc(a) {
        var b = a.i
          , c = b[F] | 0;
        return H(a, c) ? a : zc(a, b, c) ? Ac(a, b) : new a.constructor(yc(b, c, !0))
    }
    function Dc(a) {
        if (a.g !== rb)
            return !1;
    ...
    function zc(a, b, c) {
        return c & 2 ? !0 : c & 32 && !(c & 4096) ? (G(b, c | 2),
        a.g = rb,
        !0) : !1
    }
    ;var Gc = Cb(0)
    ...
    function Kc(a, b, c, d, e) {
        ...
        k !== h && (G(a, k),
        2 & k && Object.freeze(a));
        return a = Nc(a, k, f, g, b, d, m, e)
    }
    function Nc(a, b, c, d, e, f, g, h) {
        var k = b;
        f === 1 || (f !== 4 ? 0 : 2 & b || !(16 & b) && 32 & d) ? Oc(b) || (b |= !a.length || g && !(4096 & b) || 32 & d && !(4096 & b || 16 & b) ? 2 : 256,
        b !== k && G(a, b),
        Object.freeze(a)) : (f === 2 && Oc(b) && (a = Pb(a),
        k = 0,
        b = Mc(b, d),
        d = N(c, d, e, a)),
        Oc(b) || (h || (b |= 16),
        b !== k && G(a, b)));
        2 & b || !(4096 & b || 16 & b) || Fc(c, d);
        return a
    }
    function Lc(a, b) {
        2 & b && (a |= 2);
    ...
    function Pc(a, b, c, d) {
        ...
        for (n = 0; n < c.length; n++) {
            var l = c[n]
              , p = d(l, k);
            v(Object, "is").call(Object, l, p) || (m && (c = Pb(c),
            h = 0,
            g = Mc(g, f),
            m = !1),
            c[n] = p)
    ...
    var Yc = function(a, b, c) {
        a = a.i;
        return Ic(a, a[F] | 0, b, c) || b[eb] || (b[eb] = qc(b))
    }
      , Q = function(a, b, c) {
        var d = a.i
          , e = d[F] | 0;
    ...
    function Zc(a, b, c, d, e, f, g, h) {
        ...
        return a = Nc(a, n, b, c, e, f, h, g)
    }
    var R = function(a, b, c, d) {
        var e = a.i;
        return Zc(a, e, e[F] | 0, b, c, d, !1, !0)
    };
    function $c(a) {
        a == null && (a = void 0);
        return a
    ...
    var ad = function(a, b, c) {
      ...
      , cd = function(a, b, c) {
        ...
        if (c == null)
            return N(d, e, b),
            a;
        for (var f = c === kb ? 7 : c[F] | 0, g = f, h = Oc(f), k = h || Object.isFrozen(c), m = !0, n = !0, l = 0; l < c.length; l++) {
            var p = c[l];
            h || (p = H(p),
            m && (m = !p),
            n && (n = p))
    ...
    var ed = function(a, b) {
      ...
      , ld = function(a, b, c) {
        return Qc(a, b, c == null ? c : ac(c), 0)
    }
      , md = function(a, b, c) {
        return Qc(a, b, kc(c), "0")
    }
      , nd = function(a, b, c) {
        return Qc(a, b, nc(c), "")
    }
      ...
      , pd = function(a, b, c) {
        return Qc(a, b, c == null ? c : Zb(c), 0)
    }
      , qd = function(a, b, c, d) {
        return Uc(a, b, c, d == null ? d : Zb(d))
    };
...
*/
    ...
    ;function Jd(a, b) {
        a.src = Fd(b);
        (b = Id(a.ownerDocument)) && a.setAttribute("nonce", b)
    }
    ;var Kd = "alternate author bookmark canonical cite help icon license modulepreload next prefetch dns-prefetch prerender preconnect preload prev search subresource".split(" ");
    function Ld(a, b) {
        var c = a.write;
        if (b instanceof Hd)
            b = b.g;
    ...
    ;var Md = zd(function() {
        return (Da && Fa ? Fa.mobile : !Ad() && (E("iPod") || E("iPhone") || E("Android") || E("IEMobile"))) ? 2 : Ad() ? 1 : 0
    });
    function Nd(a, b) {
        if (a)
            for (var c in a)
    ...
    function Rd() {
        try {
            return Pd != null || (Pd = new Uint32Array(64)),
            Qd >= 64 && (crypto.getRandomValues(Pd),
            Qd = 0),
            Pd[Qd++]
        } catch (a) {
    ...
    ;function Sd(a, b) {
        if (!yb(a.goog_pvsid))
            try {
                var c = Rd() + (Rd() & 2097151) * 4294967296;
    ...
    ;function Td(a, b) {
        ...
        if (b == null ? 0 : b.async)
            a += " async";
        (b == null ? void 0 : b.attributionSrc) !== void 0 && (a += ' attributionsrc="' + Ud(b.attributionSrc) + '"');
        if (b == null ? 0 : b.Va)
            a += ' custom-element="' + Ud(b.Va) + '"';
        if (b == null ? 0 : b.defer)
            a += " defer";
        if (b == null ? 0 : b.id)
            a += ' id="' + Ud(b.id) + '"';
        ...
        if (b == null ? 0 : b.type)
            a += ' type="' + Ud(b.type) + '"';
        if (b == null ? 0 : b.Ha)
            a += ' crossorigin="' + Ud(b.Ha) + '"';
        b = a + ">\x3c/script>";
        b = (a = Cd()) ? a.createHTML(b) : b;
        return new Hd(b)
    }
    function Ud(a) {
    ...
    function ee(a) {
        return Sa(a.length % 4 !== 0 ? a + "A" : a).map(function(b) {
            return (q = b.toString(2),
            v(q, "padStart")).call(q, 8, "0")
        }).join("")
    }
    function fe(a) {
        if (!/^[0-1]+$/.test(a))
    ...
    var ue = function(a) {
        try {
            ...
            b.specialFeatureOptins = te(re(c, 12, le), le);
            b.purpose = {
                consents: te(re(c, 24, ke), ke),
                legitimateInterests: te(re(c, 24, ke), ke)
            };
            b.purposeOneTreatment = !!V(c, 1);
            b.publisherCC = String.fromCharCode(je + V(c, 6)) + String.fromCharCode(je + V(c, 6));
            b.vendor = {
                consents: te(se(c), null),
                legitimateInterests: te(se(c), null)
            };
            return b
        } catch (d) {
            return null
    ...
    function ze(a, b) {
        ...
        c.fetch(a, b)) : xe(c, a, b === void 0 ? !1 : b, d === void 0 ? !1 : d)
    }
    ;function Ae(a, b) {
        try {
            var c = function(d) {
    ...
    x(Ee, U);
    var Ge = function(a, b) {
        return Uc(a, 3, Fe, b == null ? b : Wb(b))
    }
      , Fe = [1, 2, 3];
    var He = function(a) {
        this.i = L(a)
    ...
    var Le = function(a) {
      ...
      , Ne = function(a, b) {
        ...
        Ec(a);
        b = a.i;
        var d = Zc(a, b, b[F] | 0, Ee, 4, 2, !0);
        c = c != null ? c : new Ee;
        d.push(c);
        var e = d === kb ? 7 : d[F] | 0
          , f = e;
        (c = H(c)) ? (e &= -9,
        d.length === 1 && (e &= -4097)) : e |= 4096;
        e !== f && G(d, e);
        c || Fc(b);
        return a
    };
    ...
    x(rf, U);
    rf.prototype.ab = function() {
        return fd(this, 2)
    }
    ;
    rf.prototype.Za = function(a) {
        var b = Kc(this, 3, oc, 3, !0);
        sb(b, a);
        return b[a]
    }
    ;
    ...
    var yf = function(a) {
        this.g = a;
        this.ja = new xf(this.g)
    }
      , xf = function(a) {
        this.g = a;
        this.ea = new zf(this.g)
    }
      , zf = function(a) {
        this.g = a;
        this.outstream = new Af;
        this.request = new Bf;
        this.threadYield = new Cf;
        this.Ia = new Df(this.g);
        this.cb = new Ef(this.g);
        this.gb = new Ff(this.g);
        this.mb = new Gf(this.g)
    }
      , Df = function(a) {
        this.g = a
    };
    Df.prototype.J = function(a) {
        this.g.o(Me(Ne(Le("av7Wxb"), Ge(new Ee, a.Ma)), Je(new He, Math.round(a.K))))
    }
    ;
    var Ef = function(a) {
        this.g = a
    ...
    Ef.prototype.J = function(a) {
        this.g.o(Me(Ne(Ne(Le("JwITQ"), Ge(new Ee, a.oa)), Ge(new Ee, a.qa)), Je(new He, Math.round(a.K))))
    }
    ;
    var Ff = function(a) {
        this.g = a
    ...
    Ff.prototype.J = function(a) {
        this.g.o(Me(Ne(Ne(Le("Pn3Upd"), Ge(new Ee, a.oa)), Ge(new Ee, a.qa)), Je(new He, Math.round(a.K))))
    }
    ;
    var Gf = function(a) {
        this.g = a
    ...
    Gf.prototype.J = function(a) {
        var b = this.g
          ...
          , d = Le("rkgGzc");
        var e = new Ee;
        e = Uc(e, 2, Fe, kc(a.source));
        d = Ne(d, e);
        e = new Ee;
        e = Uc(e, 2, Fe, kc(a.Ua));
        c.call(b, Me(Ne(d, e), Je(new He, Math.round(a.K))))
    }
    ;
    var Af = function() {}
      , Bf = function() {}
    ...
    x(If, Hf);
    If.prototype.qb = function() {
        this.l.apply(this, B(sa.apply(0, arguments).map(function(a) {
            return {
                S: !0,
                ba: 2,
                Z: K(a)
    ...
    Kf.prototype.l = function() {
        var a = sa.apply(0, arguments)
          , b = this;
        try {
            this.V && Ae(this.g.concat(a), De(this)).length >= 65536 && Lf(this),
            this.L && !this.O && (this.O = !0,
            this.L.g(function() {
                Lf(b)
            })),
            this.g.push.apply(this.g, B(a)),
            this.g.length >= this.U && Lf(this),
    ...
    var Mf = function(a, b, c, d, e, f, g) {
        Kf.call(this, a, b, "https://pagead2.googlesyndication.com/pagead/ping", Jf, c === void 0 ? 1E3 : c, d === void 0 ? 100 : d, (e === void 0 ? !1 : e) && !!u.globalThis.fetch, f, g)
    };
    x(Mf, Kf);
    var Nf = function(a) {
        this.g = a;
    ...
    var Pf = new Of(695925491,20)
      , Qf = new Nf(45624259)
      , Rf = new Of(635239304,100)
      , Sf = new Nf(662101539)
      , Tf = new Of(682056200,100)
      , Uf = new Of(24)
      , Vf = new function(a, b) {
        b = b === void 0 ? [] : b;
        this.g = a;
    ...
    ;ae(be).map(function(a) {
        return Number(a)
    });
    ae(ce).map(function(a) {
        return Number(a)
    });
    var dg = function(a) {
        this.g = a
      ...
      , eg = function(a) {
        a.j = function(b) {
            ...
            a.g.__tcfapi)(e.command, e.version, function(f, g) {
                var h = {};
    ...
    ;var sg = function(a) {
        ...
        this.tcString = (c = bg(a.document)) && oc(M(c, 1)) != null ? S(c, 1) : null;
        this.j = (a = bg(a.document)) && oc(M(a, 2)) != null ? S(a, 2) : null
    }
      , vg = function(a) {
        a === a.top && (a = new sg(a),
        tg(a),
      ...
      , rg = function(a) {
        if (a == null || oc(M(a, 1)) == null || S(a, 1).length === 0 || R(a, jg, 2, P()).length === 0)
            return null;
        var b = S(a, 1);
        try {
            var c = he(b.split("~")[0]);
        ...
        a = R(a, jg, 2, P()).reduce(function(e, f) {
            var g = wg(e);
            g = hd(g, 1);
            g = pg(g);
            var h = wg(f);
        ...
        c = Kc(c, 3, bc, P()).indexOf(fd(a, 1));
        return c === -1 || c >= d.length ? null : {
            uspString: mg(d[c], fd(a, 1)),
            la: oe(wg(a))
        }
    }
      , wg = function(a) {
        return Jc(a, me, 2) ? Q(a, me, 2) : ne()
    }
      , ug = function(a) {
        !a.tcString || a.g.__tcfapi || a.g.frames.__tcfapiLocator || (a.g.__tcfapiManager = "fc",
        ng(a.g, "__tcfapiLocator"),
    ...
    var xg = pa(["https://pagead2.googlesyndication.com/pagead/managed/dict/", "/gpt"])
      , yg = pa(["https://securepubads.g.doubleclick.net/pagead/managed/dict/", "/gpt"]);
    function zg(a, b, c) {
        try {
            var d = a.createElement("link"), e, f;
    ...
    var Lg = function(a, b, c) {
        var d = d === void 0 ? new Mf(6,"unknown",b) : d;
        this.C = a;
        this.o = c;
        this.j = d;
        this.g = [];
    ...
    function Yg(a) {
        var b = W(Qg).A;
        if (b && Vc(a, Kg) !== 8) {
            var c = Oa(R(a, Hg, 5, P()), function(f) {
                f = Eg(Q(f, ef, 1), b);
    ...
    function eh(a, b, c, d, e) {
        ...
        for (var h = b.next(); !h.done; h = b.next()) {
            h = h.value;
            for (var k = Xg(h), m = y(a), n = m.next(); !n.done; n = m.next()) {
                n = n.value;
                var l = Vc(n, Kg)
                  , p = Sg(n, l);
                if (p) {
                    var r = void 0
                      , t = void 0
                      , z = void 0;
                    var A = (r = (z = W(Wg).g.get(h)) == null ? void 0 : (t = z.get(p)) == null ? void 0 : t.slice(0)) != null ? r : [];
                    a: {
                        r = p;
                        t = l;
                        z = new $e;
                    ...
                    if (r = A)
                        t = void 0,
                        r = !((t = W(Wg).l[h]) == null || !t.has(p));
                    r && f.push(A);
                    if (l === 8 && k[p])
                        A = Jg(JSON.stringify(k[p])),
                        l = Xc(n, Fg, 4),
                        A = Gg(Yc(A, Fg, 4)),
                        dd(l, A);
                    else {
    ...
    function hh(a) {
        (q = W(Wg).o,
        v(q, "includes")).call(q, a) || dh(Xg(4), a)
    }
    ;function X(a, b, c) {
    ...
    function jh(a) {
        ...
        X(14, function(b) {
            for (var c = W(Qg), d = y([3, 4, 5]), e = d.next(); !e.done; e = d.next())
                e = e.value,
                v(Object, "assign").call(Object, c.A[e], b[e])
        }, a)
    }
    function kh(a) {
    ...
    qh[69] = function(a) {
        ...
        b = b === void 0 ? document : b;
        var c;
        return !((c = b.featurePolicy) == null || !(q = c.features(),
        v(q, "includes")).call(q, a))
    }
    ,
    qh[70] = function(a) {
        var b = D.document;
        b = b === void 0 ? document : b;
        var c;
        return !((c = b.featurePolicy) == null || !(q = c.allowedFeatures(),
        v(q, "includes")).call(q, a))
    }
    ,
    qh[79] = function(a) {
            ...
            f = e.next(); !f.done; f = e.next())
                ...
                yh(f).length !== 0) {
                    ...
                    if (T(f, 4) && !T(f, 13) && !T(f, 14)) {
                        ...
                        h = gd(f, 1) * yh(f).length;
                        c.set(T(f, 4), g + h)
                    }
                    h = [];
                    for (var k = 0; k < yh(f).length; k++) {
                        var m = {
                            Sa: g,
                            Na: gd(f, 1),
                            Oa: yh(f).length,
                    ...
                    Eh(a[2], T(f, 10), h) || Eh(a[1], T(f, 4), h) || Eh(a[0], yh(f)[0].getId(), h)
                }
        return a
    }
    function Eh(a, b, c) {
    ...
    ;var Lh = [12, 13, 20]
      ...
      , Ph = function(a, b, c, d) {
        ...
        if (f = b !== 9)
            ...
            f = !1);
        if (f)
            return Ng(a.u, b, c, e, [], 4),
            e;
        f = v(Lh, "includes").call(Lh, b);
        for (var g = [], h = [], k = y([0, 1, 2]), m = k.next(); !m.done; m = k.next()) {
            ...
            for (var n = y(v(a.R[m], "entries").call(a.R[m])), l = n.next(); !l.done; l = n.next()) {
                ...
                p = t.filter(function(db) {
                    return db.ca === b && a.j[db.F.getId()] && Nh(a, db)
                });
                if (p.length)
                    for (l = y(p),
                    p = l.next(); !p.done; p = l.next())
                        h.push(p.value.F);
                else if (!a.ma) {
                    p = void 0;
                    m === 2 ? (p = d[1],
                    ...
                    if (p !== void 0) {
                        ...
                        for (t = r.next(); !t.done; t = r.next())
                            ...
                            t.ca === b) {
                                ...
                                var cb = ra.Oa;
                                ra = ra.ib;
                                z < 0 || z >= A * cb || z % cb !== ra || !Nh(a, t) || (z = T(t.ia, 13),
                                z !== 0 && z !== void 0 && (A = a.l[String(z)],
                                A !== void 0 && A !== t.F.getId() ? Og(a.u, a.l[String(z)], t.F.getId(), z) : a.l[String(z)] = t.F.getId()),
                                h.push(t.F))
                            }
                        Vc(l, Te) !== 0 && (ld(l, 3, p),
                        g.push(l))
      ...
      , Nh = function(a, b) {
        var c = W(Qg).A
          , d = Eg(Q(b.ia, ef, 3), c);
        if (!d.success)
            return Pg(a.u, Q(b.ia, ef, 3), b.ca, b.F.getId(), d),
            !1;
        if (!d.value)
            return !1;
        c = Eg(Q(b.F, ef, 3), c);
        return c.success ? c.value ? !0 : !1 : (Pg(a.u, Q(b.F, ef, 3), b.ca, b.F.getId(), c),
        !1)
    }
      , Qh = function(a, b) {
        b = b.map(function(c) {
            ...
            return !v(Lh, "includes").call(Lh, T(c, 1))
        });
        a.R = Dh(a.R, b)
    }
      , Rh = function(a, b) {
    ...
    function Th(a) {
        return W(Sh).j(a.g, a.defaultValue)
    }
    ;var Uh = function() {
        this.g = function() {}
    }
    ...
    ;var Xh, Yh, Zh, $h, ai, bi;
    function ci(a) {
        var b = a.Ya;
        var c = a.A;
        var d = a.config;
        var e = a.Ta === void 0 ? vh() : a.Ta;
        var f = a.Fa === void 0 ? 0 : a.Fa;
        var g = a.u === void 0 ? new Lg(($h = og((Xh = Q(b, Ah, 5)) == null ? void 0 : hd(Xh, 2))) != null ? $h : 0,(ai = og((Yh = Q(b, Ah, 5)) == null ? void 0 : hd(Yh, 4))) != null ? ai : 0,(bi = (Zh = Q(b, Ah, 5)) == null ? void 0 : ed(Zh, 3)) != null ? bi : !1) : a.u;
        a = a.R === void 0 ? Ch(R(b, zh, 2, P(tb))) : a.R;
        e.hasOwnProperty("init-done") ? (Y(12, e, function() {})(R(b, zh, 2, P()).map(function(h) {
            return K(h)
        })),
        Y(13, e, function() {})(R(b, Ig, 1, P()).map(function(h) {
            return K(h)
        }), f),
        c && Y(14, e, function() {})(c),
        di(f, e)) : (Rh(new Mh(a,f,g,d), e),
        ih(e),
        jh(e),
        kh(e),
        di(f, e),
        eh(R(b, Ig, 1, P(tb)), [f], g, void 0, !0),
        Rg = Rg || !(!d || !d.pa),
        Wh(uh),
        c && Wh(c))
    }
    function di(a, b) {
        var c = b = b === void 0 ? vh() : b;
        mh(W(lh), c, a);
        ei(b, a);
        a = b;
        Vh(W(Uh), a);
    ...
    ;var fi = pa(["https://pagead2.googlesyndication.com/pagead/js/err_rep.js"])
      , gi = function() {
        var a = a === void 0 ? "jserror" : a;
        var b = b === void 0 ? .01 : b;
        var c = c === void 0 ? Vd(fi) : c;
        this.g = a;
        this.l = b;
        this.j = c
    };
    ...
    function pi(a, b, c) {
        ...
        return function() {
            ...
            try {
                ...
                e.google_measure_js_timing && h && ni(v(Object, "assign").call(Object, {}, {
                    label: a.toString(),
                    value: h,
                    duration: (mi() || 0) - h,
                    type: k
    ...
    function qi(a, b) {
        return pi(a, b, function(c, d) {
            ...
            Math.random() > f || (d.error && d.meta && d.id || (d = new we(d,{
                context: c,
                id: g
            })),
            D.google_js_errors = D.google_js_errors || [],
            D.google_js_errors.push(d),
            D.error_rep_loaded || (f = D.document,
            c = Zd("SCRIPT", f),
            Jd(c, e.j),
    ...
    function si() {
        ...
        try {
            if (!b)
                return a;
            for (var c = b.pubads(), d = y(c.getSlots()), e = d.next(); !e.done; e = d.next())
    ...
    function ti(a) {
        a = a.id;
        return a != null && (si().has(a) || v(a, "startsWith").call(a, "google_ads_iframe_") || v(a, "startsWith").call(a, "aswift"))
    }
    function ui(a, b, c) {
        if (!a.sources)
            return !1;
    ...
    var Ai = function() {
        ...
        var a = new Ai;
        if (W(Sh).g(Sf.g, Sf.defaultValue)) {
            var b = window;
        ...
        a.u || (a.u = new PerformanceObserver(qi(640, function(b) {
            Gi(a, b)
        })));
        return a.u
    }, Ei = function(a) {
        ...
        if (!a.Aa) {
            ...
            window.LayoutShift && (b += ri("cls", a.N),
            b += ri("mls", a.V),
            b += Z("nls", a.X),
            window.LayoutShiftAttribution && (b += ri("cas", a.C),
            b += Z("nas", a.za),
            b += ri("was", a.Ea)),
            b += ri("wls", a.ka),
            b += ri("tls", a.Da));
            window.LargestContentfulPaint && (b += Z("lcp", a.xa),
            b += Z("lcps", a.wa));
            window.PerformanceEventTiming && a.ua && (b += Z("fid", a.ta));
            window.PerformanceLongTaskTiming && (b += Z("cbt", a.L),
            b += Z("mbt", a.U),
            b += Z("nlt", a.Y));
            ...
            b += "&top=" + (D === D.top ? 1 : 0);
            b += a.Ca ? "&qqid=" + encodeURIComponent(a.Ca) : Z("pvsid", $d(D));
        ...
        if (!b.hadRecentInput) {
            ...
            a.j > a.ka && (a.ka = a.j,
            a.Ea = a.l,
            a.Da = b.startTime + b.duration)
        }
    }, Gi = function(a, b) {
        var c = Bi !== window.scrollX || Ci !== window.scrollY ? [] : Ji
          , d = Ki();
        b = y(b.getEntries());
        ...
        b.interactionId && (a.W = Math.min(a.W, b.interactionId),
        a.o = Math.max(a.o, b.interactionId),
        a.va = a.o ? (a.o - a.W) / 7 + 1 : 0)
    }, Ki = function() {
        var a = v(Array, "from").call(Array, document.getElementsByTagName("iframe")).filter(ti)
          , b = [].concat(B(si())).map(function(c) {
        ...
        Bi = window.scrollX;
        Ci = window.scrollY;
        return Ji = [].concat(B(a), B(b)).map(function(c) {
    ...
    var Yi = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    function Zi(a) {
        var b;
    ...
    function aj(a) {
        ...
        a = a.navigator.userAgentData.getHighEntropyValues(Yi).then(function(c) {
    ...
    function bj(a) {
        var b;
        return Vi(Ui(Si(Pi(Wi(Ri(Xi(Ti(Qi(new Oi, a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""), ((b = a.fullVersionList) == null ? void 0 : b.map(function(c) {
            var d = new Ni;
            d = O(d, 1, nc(c.brand));
    ...
    function cj(a) {
        var b, c;
        return (c = (b = aj(a)) == null ? void 0 : b.then(function(d) {
            return bj(d)
        })) != null ? c : null
    }
    ;var dj = function(a) {
    ...
    ;var oj = /^(?:https?:)?\/\/(?:www\.googletagservices\.com|securepubads\.g\.doubleclick\.net|(pagead2\.googlesyndication\.com))(\/tag\/js\/gpt(?:_[a-z]+)*\.js)/;
    function pj(a) {
        var b = a.La;
        var c = a.hb;
        var d = a.Ra;
        ...
        ,
        a[59] = function() {
            var m = sa.apply(0, arguments), n = v(m, "includes"), l = String, p;
            var r = r === void 0 ? window : r;
            var t;
            r = (t = (p = Gh(r.location.href.match(Fh)[3] || null)) == null ? void 0 : p.split(".")) != null ? t : [];
            p = r.length < 2 ? null : (q = ["uk", "br", "nz", "mx"],
            v(q, "includes")).call(q, r[r.length - 1]) ? r.length < 3 ? null : Jh(r.splice(r.length - 3).join(".")) : Jh(r.splice(r.length - 2).join("."));
            return n.call(m, l(p))
        }
        ,
        a[74] = function() {
            return v(sa.apply(0, arguments), "includes").call(sa.apply(0, arguments), String(Jh(window.location.href)))
        }
        ,
        a[61] = function() {
            return e
    ...
    ;function qj(a, b) {
        if (W(Sh).g(Qf.g, Qf.defaultValue)) {
            var c = function(d) {
                d.data != null && d.data !== "" || d.origin.indexOf("android-app://") !== 0 || (b(),
    ...
    ;function rj(a) {
        return !(a == null || !a.src) && Gh(a.src.match(Fh)[3] || null) === "pagead2.googlesyndication.com"
    }
    ;var sj = pa(["https://pagead2.googlesyndication.com/pagead/managed/js/gpt/", "/pubads_impl.js"])
      , tj = pa(["https://securepubads.g.doubleclick.net/pagead/managed/js/gpt/", "/pubads_impl.js"]);
    function uj(a) {
        a = rj(a) ? Vd(sj, "m202510060101") : Vd(tj, "m202510060101");
        var b = Th(Uf);
        return b ? Wd(a, new u.Map([["cb", b]])) : a
    }
    ;function vj(a, b) {
        var c = mj(246);
        c = vc(c);
        c = sd(Bh, c);
        if (!R(c, Ig, 1, P()).length && R(a, Ig, 1, P()).length) {
            var d = R(a, Ig, 1, P());
            cd(c, 1, d)
        }
        !R(c, zh, 2, P()).length && R(a, zh, 2, P()).length && (d = R(a, zh, 2, P()),
        cd(c, 2, d));
        !Jc(c, Ah, 5) && Jc(a, Ah, 5) && (a = Q(a, Ah, 5),
        ad(c, 5, a));
        nj(246, K(c));
        ci({
            Ya: c,
    ...
    x(wj, hj);
    var xj = pa(["https://pagead2.googlesyndication.com/pagead/ppub_config"])
      , yj = pa(["https://securepubads.g.doubleclick.net/pagead/ppub_config"]);
    function zj(a, b, c, d, e) {
        a = a.location.host;
        var f = Ih(b.src, "domain");
        b = Ih(b.src, "network-code");
        if (a || f || b) {
            var g = new u.Map;
            a && g.set("ippd", a);
            f && g.set("pppd", f);
        ...
        a ? (c = c ? Vd(xj) : Vd(yj),
        c = Wd(c, a),
        Aj(c, d, e)) : e(new u.globalThis.Error("no provided or inferred data"))
    }
    function Aj(a, b, c) {
        u.globalThis.fetch(a.toString(), {
            ...
            d.status < 300 ? (oi("13", window),
            d.status === 204 ? b("") : d.text().then(function(e) {
                b(e)
    ...
    ;var Bj = function(a, b, c) {
      ...
      , Fj = function(a, b, c, d, e) {
        var f = e == null ? void 0 : vd(Yc(e, ud, 1));
        (f == null ? 0 : f.length) && v(b.location.hostname, "includes").call(b.location.hostname, f) ? (Cj(a),
        Dj(a, {
            lb: e
        })) : (q = ["http:", "https:"],
        v(q, "includes")).call(q, b.location.protocol) ? c ? (Cj(a),
        zj(yd(b), c, d, function(g) {
            return void Dj(a, {
                nb: g
            })
        }, function(g) {
        ...
        if (ii(a.M.P, d)) {
            ...
            a: {
                if (u.globalThis.performance) {
                    ...
                    if (v(Number, "isFinite").call(Number, k) && k > 0)
                        break a
                }
                k = Date.now();
    ...
    var Gj = function(a) {
        return function(b) {
            b = JSON.parse(b);
            if (!Array.isArray(b))
                throw Error("Expected jspb data to be an array, got " + xa(b) + ": " + b);
            mb(b, 34);
            return new a(b)
        }
    }(dj)
    ...
    ;function Lj() {
        ...
        if (fetch) {
            ...
            a = Ij(a, e);
            vb(!W(lj).g);
            v(Object, "assign").call(Object, kj, b._vars_);
            b._vars_ = kj;
            a && (ed(a, 3) && nj(36, !0),
            S(a, 6) && nj(150, S(a, 6)),
            li(Yc(a, ji, 13)) && nj(263, !0));
            var f = Yc(a, Bh, 1)
              , g = {
                fb: ki(Yc(a, ji, 13)),
                hb: fd(a, 2),
            ...
            Kj("_loaded_", !0);
            Kj("cmd", []);
            var n, l = (n = Nj(m)) != null ? n : Oj(m);
            Pj(f, k, v(Object, "assign").call(Object, {}, {
                La: l
            }, g));
            try {
                Fi()
            ...
            if (ii(c.P, g)) {
                ...
                p.cb.J({
                    K: g,
                    oa: f,
                    qa: Gh(n.toString().match(Fh)[3] || null) === "pagead2.googlesyndication.com"
                })
            }
            var r = !1;
            gj({
            ...
            Fj(new Bj(c,d,e), k, l, rj(l), h);
            qj(k, function() {
                r = !0
            });
            S(a, 14) && zg(k.document, Ag(S(a, 14), rj(l)), e)
        } else
            d.ga.ja.ea.Ia.J({
                K: 1,
                Ma: !1
    ...
    function Pj(a, b, c) {
        ...
        ij(12);
        ij(5);
        (a = cj(b)) && a.then(function(d) {
            return void nj(251, JSON.stringify(K(d)))
        });
        Yd(W(Sh).l(Vf.g, Vf.defaultValue), b.document)
    }
    function Qj(a) {
        var b = Nj(a);
